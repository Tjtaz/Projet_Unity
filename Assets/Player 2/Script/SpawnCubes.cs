...
public class SpawnCubes : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("l") && coolDownTimer ==0)
        {
            SpawnCubeMiddle();
            coolDownTimer = coolDown;
        }
        if (Input.GetKeyDown("k") && coolDownTimer == 0)
        {
            SpawnCubeLeft();
            coolDownTimer = coolDown;
        }
        if (Input.GetKeyDown("m") && coolDownTimer == 0)
        {
            SpawnCubeRight();
            coolDownTimer = coolDown;
        }
        if (Input.GetKeyDown("o") && coolDownTimer == 0)
        {
            SpawnCubeUp();
            coolDownTimer = coolDown;
        }
        if (Input.GetKeyDown("p") && coolDownTimer == 0)
        {
            SpawnCubeDown();
            coolDownTimer = coolDown;
        }
